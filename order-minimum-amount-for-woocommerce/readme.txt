...
* [Frip In: 6 Best WooCommerce Minimum Maximum Quantity Plugin](https://www.frip.in/woocommerce-minimum-maximum-quantity-plugin/#4 "Frip In: 6 Best WooCommerce Minimum Maximum Quantity Plugin")

* [WPGlob: Best WordPress Product Management Plugins For Easy Usage](https://wpglob.com/best-wordpress-product-management-plugins-for-easy-usage/ "WPGlob: Best WordPress Product Management Plugins For Easy Usage")
...
> “Just Amazing!: Requested a feature and in no time new version was released with enhancements. Really appreciate the effort!” – ⭐⭐⭐⭐⭐ [Gangesh Matta](https://wordpress.org/support/topic/just-amazing-117/)

> “Very good plugin and excellent support!: Very responsive support. Bugs acknowledged and fixed. Product enhancement requests fulfilled lighting fast. Simply amazing!” – ⭐⭐⭐⭐⭐ [jlstysis](https://wordpress.org/support/topic/very-good-plugin-and-excellent-support-12/)
___
...
* Control order amounts for membership stores

* Compatible with [WooCommerce Memberships](https://woocommerce.com/products/woocommerce-memberships/ "WooCommerce Memberships"), [MemberPress](https://memberpress.com/ "MemberPress") and [SUMO Memberships](https://fantasticplugins.com/shop/sumo-memberships/ "SUMO Memberships") plugins.
...
* **Product Bundles:** Compatibility with [Product Bundles](https://woocommerce.com/products/product-bundles/ "Product Bundles") by including bundled cart item on cart total calculation, or creating bundle price amount type

* **WooCommerce Subscriptions:** Compatibility with [WooCommerce Subscriptions](https://woocommerce.com/pt-br/products/woocommerce-subscriptions/ "WooCommerce Subscriptions") by skipping min/max amount checks if the user has a switching subscription item in cart

* **Currency Switcher for WooCommerce:** Compatibility with [Currency Switcher for WooCommerce – By WP Wham](https://wordpress.org/plugins/currency-switcher-woocommerce/ "Currency Switcher for WooCommerce") to get exchange rates from the Currency Switcher plugin
...
> “the plugin is very well made, it has many options even in the free version. I needed support and it solved my problem in just a few seconds. I am very satisfied” – ⭐⭐⭐⭐⭐ [Maurizio Coda](https://wpfactory.com/item/order-minimum-maximum-amount-for-woocommerce/?utm_source=wporg&utm_medium=organic&utm_campaign=readme)
...
= 4.7.0 - 29/01/2026 =
* Fix - Fixed format from `<pre>` on "Messages > Good to know".
* Fix - Hide "add to cart" button - Prevented PHP warnings regarding `line_tax` and `line_total`.
...
= 4.6.6 - 31/07/2025 =
* Dev - Fees - Added option to apply tax on fee.
* Dev - Fees - Added option to apply tax class on fee.
* Dev - Improved formatting of admin settings tips.
* Dev - Updated WPFactory menu library to version 1.0.8.
* Moved older changelog entries to file `changelog-older.txt`.
...
= 4.6.4 - 08/04/2025 =
* Fix - Products - Fixed per category limit.
* Fix - Fees - Fixed Cart total calculation option miscalculating the %total% with the Products section.
...
* Fix - Payment Gateways - Hide unavailable - Fixed "get_cart()" error in admin when enabled.
...
= 4.6.0 - 24/02/2025 =
* Fix - Messages - Improved messages display on page load while using cart/checkout blocks.
* Fix - Messages - Prevented DOM-breaking issues when using cart/checkout block positions.

= 4.5.9 - 20/02/2025 =
* Fix - Prevented duplicated notices.
* Fix - Prevented reloading of the address blocks.
* Dev - Added detection for changes on the classic checkout page.

= 4.5.8 - 19/02/2025 =
* Fixed missing Composer libraries.
...
[View older changelog entries](https://plugins.svn.wordpress.org/order-minimum-amount-for-woocommerce/trunk/changelog-older.txt)
